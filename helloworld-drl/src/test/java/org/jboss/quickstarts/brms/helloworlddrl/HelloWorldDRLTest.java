...
public class HelloWorldDRLTest {
    ...
    private Sale vipSale = new Sale(vipCustomer, 1000);
    // A sale for a regular customer
    private Sale regularSale = new Sale(regularCustomer, 1000);
    // A sale for a Bad customer
    private Sale badSale = new Sale(badCustomer, 50);
    ...
    public void testGoodCustomer() {
        ...
        assertTrue(vipSale.isApproaved());
    ...
    public void testRegularCustomer() {
        ...
        assertTrue(regularSale.isApproaved());
    ...
    public void testBadCustomer() {
        ...
        assertFalse(badSale.isApproaved());
    }
